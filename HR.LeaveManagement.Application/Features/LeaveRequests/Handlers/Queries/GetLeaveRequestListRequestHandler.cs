...
namespace HR.LeaveManagement.Application.Features.LeaveRequests.Handlers.Queries
{
    ...
    public class GetLeaveRequestListRequestHandler : IRequestHandler<GetLeaveRequestListRequest, List<LeaveRequestDto>>
    {
        ...
        {
            var leaveRequests = await _leaveRequestRepository.GetLeaveRequestsWithDetails(); //gets all data from db

            return _mapper.Map<List<LeaveRequestDto>>(leaveRequests); //converts "leaveRequests" to "LeaveAllocationDto"
        }
    }
}
